...
<div id="goodsListArea">
			...
			<div class="columnArea dFlex">
				<span>번호</span> <span>상품명</span> <span>상품코드</span> <span>가격</span> <span>재고</span>
				<span>등록시간</span>
	...
	<fmt:formatNumber var="pricePrn" value="${goods.price}" pattern="0,000"/>
					...
					<span>${goods.cnt}</span>
					<span>${tm}</span>
	<fmt:formatDate var="tm" value="${goods.regTM}"	pattern="yyyy-MM-dd"/>
